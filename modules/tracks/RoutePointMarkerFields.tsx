...
import { MARKER_ICONS, type MarkerIconId } from '../annotations/icons';
...
export function RoutePointMarkerFields({ initial, onAdd, onBack }: {
  ...
  const iconImage=(id:MarkerIconId)=><svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d={MARKER_ICONS[id].path}/></svg>;
