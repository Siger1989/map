...
public final class MainActivity extends Activity {
    ...
    @Override public void onBackPressed() {
        webView.evaluateJavascript("(function(){var p=document.querySelector('.offline-download-dock')||document.querySelector('.place-share-panel')||document.querySelector('.route-dialog')||document.querySelector('.raster-level-panel')||document.querySelector('.section-list')||document.querySelector('.area-editor')||document.querySelector('.area-selection')||document.querySelector('.area-drawing-tools')||document.querySelector('.object-gizmo[data-active=true]')||document.querySelector('.section-profile')||document.querySelector('.photo-lightbox[open]')||document.querySelector('.trip-photo-viewer')||document.querySelector('.quick-add')||document.querySelector('.layer-window')||document.querySelector('.control-dock.is-expanded')||document.querySelector('.object-gizmo')||document.querySelector('.observatory[data-section=\"true\"],.observatory[data-editing-track=\"true\"],.observatory[data-picking-route=\"true\"],.observatory[data-placing-annotation=\"true\"]');if(!p)return false;p.dispatchEvent(new KeyboardEvent('keydown',{key:'Escape',bubbles:true}));return true;})()", result -> {
