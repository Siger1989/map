...
public final class MainActivity extends Activity {
    ...
    @Override public void onBackPressed() {
        webView.evaluateJavascript("(function(){var p=document.querySelector('.control-dock.is-expanded')||document.querySelector('.observatory[data-editing-track=\"true\"],.observatory[data-picking-route=\"true\"]');if(!p)return false;p.dispatchEvent(new KeyboardEvent('keydown',{key:'Escape',bubbles:true}));return true;})()", result -> {
