...
public final class MainActivity extends Activity {
    ...
    @Override public void onBackPressed() {
        webView.evaluateJavascript("(function(){var p=document.querySelector('.photo-lightbox[open]')||document.querySelector('.trip-photo-viewer')||document.querySelector('.quick-add')||document.querySelector('.layer-window')||document.querySelector('.control-dock.is-expanded')||document.querySelector('.observatory[data-section=\"true\"],.observatory[data-editing-track=\"true\"],.observatory[data-picking-route=\"true\"],.observatory[data-placing-annotation=\"true\"]');if(!p)return false;p.dispatchEvent(new KeyboardEvent('keydown',{key:'Escape',bubbles:true}));return true;})()", result -> {
